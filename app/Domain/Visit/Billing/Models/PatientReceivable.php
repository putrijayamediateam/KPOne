...
class PatientReceivable extends Model
{
    ...
    {
        return ['amount_sen' => 'integer', 'remaining_sen' => 'integer', 'lock_version' => 'integer', 'expected_invoice_version' => 'integer', 'due_date' => 'immutable_date', 'approved_at' => 'immutable_datetime', 'settled_at' => 'immutable_datetime'];
    }
