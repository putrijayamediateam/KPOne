...
class DispensaryDirectoryService
{
    ...
    public function detail(User $actor, DispensaryCase $case): array
    {
        ...
        $handoff = $case->handoffs->firstOrFail();
